...
class RoadmapService {
    ...
    updateRoadmapStep = async (req, res) => {
        ...
        if (!isNumberBetweenOrEqual({
            ...
            throw new BadRequestException("Each roadmap step list (courses | youtubePlaylists | books) must be at most 5 items length, and only (courses | youtubePlaylists | quizzes) must be at least 1 item length, must be at most 1 item length ❌");
        }
