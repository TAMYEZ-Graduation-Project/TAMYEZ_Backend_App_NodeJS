abstract class EnvFields {
  ...
  // Cloudflare
  static readonly CLOUDFLARE_ACCOUNT_ID = "CLOUDFLARE_ACCOUNT_ID";
  static readonly CLOUDFLARE_BUCKET_S3_API = "CLOUDFLARE_BUCKET_S3_API";
  static readonly CLOUDFLARE_BUCKET_NAME = "CLOUDFLARE_BUCKET_NAME";
  static readonly CLOUDFLARE_REGION = "CLOUDFLARE_REGION";
  static readonly CLOUDFLARE_ACCESS_KEY_ID = "CLOUDFLARE_ACCESS_KEY_ID";
  static readonly CLOUDFLARE_SECRET_ACCESS_KEY = "CLOUDFLARE_SECRET_ACCESS_KEY";
  ...
  // Quiz
  static readonly NUMBER_OF_QUESTIONS_FOR_CAREER_ASSESSMENT =
    "NUMBER_OF_QUESTIONS_FOR_CAREER_ASSESSMENT";
  static readonly NUMBER_OF_QUESTIONS_FOR_ROADMAP_STEP_QUIZ =
    "NUMBER_OF_QUESTIONS_FOR_ROADMAP_STEP_QUIZ";
}
